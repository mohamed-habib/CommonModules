...
import codelab.android.com.commonmodules.R;
...
public class LocalStorageProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        row.add(DocumentsContract.Root.COLUMN_ICON, R.mipmap.ic_provider);
    ...
    @Override
    public AssetFileDescriptor openDocumentThumbnail(String documentId, Point sizeHint, android.os.CancellationSignal signal) throws FileNotFoundException {
